...
size_t gles2_decoder_context_t::decode(void *buf, size_t len, IOStream *stream)
{
	...
	while ((len - pos >= 8) && !unknownOpcode) {   
		...
		case OP_glAttachShader: {
			...
			glAttachShader(var_program, var_shader);
		...
		case OP_glBindAttribLocation: {
			...
			glBindAttribLocation(var_program, var_index, (const GLchar*)(inptr_name.get()));
		...
		case OP_glBindFramebuffer: {
			...
			glBindFramebuffer(var_target, var_framebuffer);
		...
		case OP_glBindRenderbuffer: {
			...
			glBindRenderbuffer(var_target, var_renderbuffer);
		...
		case OP_glBlendColor: {
			...
			glBlendColor(var_red, var_green, var_blue, var_alpha);
		...
		case OP_glBlendEquationSeparate: {
			...
			glBlendEquationSeparate(var_modeRGB, var_modeAlpha);
		...
		case OP_glBlendFuncSeparate: {
			...
			glBlendFuncSeparate(var_srcRGB, var_dstRGB, var_srcAlpha, var_dstAlpha);
		...
		case OP_glCheckFramebufferStatus: {
			...
			*(GLenum *)(&tmpBuf[0]) = 			glCheckFramebufferStatus(var_target);
			if (useChecksum) {
		...
		case OP_glCreateProgram: {
			...
			*(GLuint *)(&tmpBuf[0]) = 			glCreateProgram();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glCreateShader: {
			...
			*(GLuint *)(&tmpBuf[0]) = 			glCreateShader(var_type);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glDeleteFramebuffers: {
			...
			glDeleteFramebuffers(var_n, (const GLuint*)(inptr_framebuffers.get()));
		...
		case OP_glDeleteRenderbuffers: {
			...
			glDeleteRenderbuffers(var_n, (const GLuint*)(inptr_renderbuffers.get()));
		...
		case OP_glDetachShader: {
			...
			glDetachShader(var_program, var_shader);
		...
		case OP_glDisableVertexAttribArray: {
			...
			glDisableVertexAttribArray(var_index);
		...
		case OP_glFramebufferRenderbuffer: {
			...
			glFramebufferRenderbuffer(var_target, var_attachment, var_renderbuffertarget, var_renderbuffer);
		...
		case OP_glFramebufferTexture2D: {
			...
			glFramebufferTexture2D(var_target, var_attachment, var_textarget, var_texture, var_level);
		...
		case OP_glGenFramebuffers: {
			...
			glGenFramebuffers(var_n, (GLuint*)(outptr_framebuffers.get()));
		...
		case OP_glGenRenderbuffers: {
			...
			glGenRenderbuffers(var_n, (GLuint*)(outptr_renderbuffers.get()));
		...
		case OP_glGetActiveAttrib: {
			...
			glGetActiveAttrib(var_program, var_index, var_bufsize, size_length == 0 ? NULL : (GLsizei*)(outptr_length.get()), size_size == 0 ? NULL : (GLint*)(outptr_size.get()), size_type == 0 ? NULL : (GLenum*)(outptr_type.get()), size_name == 0 ? NULL : (GLchar*)(outptr_name.get()));
			outptr_length.flush();
			outptr_size.flush();
			outptr_type.flush();
			outptr_name.flush();
		...
		case OP_glGetActiveUniform: {
			...
			glGetActiveUniform(var_program, var_index, var_bufsize, size_length == 0 ? NULL : (GLsizei*)(outptr_length.get()), size_size == 0 ? NULL : (GLint*)(outptr_size.get()), size_type == 0 ? NULL : (GLenum*)(outptr_type.get()), size_name == 0 ? NULL : (GLchar*)(outptr_name.get()));
			outptr_length.flush();
			outptr_size.flush();
			outptr_type.flush();
			outptr_name.flush();
		...
		case OP_glGetAttachedShaders: {
			...
			glGetAttachedShaders(var_program, var_maxcount, size_count == 0 ? NULL : (GLsizei*)(outptr_count.get()), (GLuint*)(outptr_shaders.get()));
			outptr_count.flush();
		...
		case OP_glGetAttribLocation: {
			...
			*(int *)(&tmpBuf[0]) = 			glGetAttribLocation(var_program, (const GLchar*)(inptr_name.get()));
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glGetFramebufferAttachmentParameteriv: {
			...
			glGetFramebufferAttachmentParameteriv(var_target, var_attachment, var_pname, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetProgramiv: {
			...
			glGetProgramiv(var_program, var_pname, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetProgramInfoLog: {
			...
			glGetProgramInfoLog(var_program, var_bufsize, size_length == 0 ? NULL : (GLsizei*)(outptr_length.get()), (GLchar*)(outptr_infolog.get()));
			outptr_length.flush();
		...
		case OP_glGetRenderbufferParameteriv: {
			...
			glGetRenderbufferParameteriv(var_target, var_pname, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetShaderiv: {
			...
			glGetShaderiv(var_shader, var_pname, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetShaderInfoLog: {
			...
			glGetShaderInfoLog(var_shader, var_bufsize, size_length == 0 ? NULL : (GLsizei*)(outptr_length.get()), (GLchar*)(outptr_infolog.get()));
			outptr_length.flush();
			outptr_infolog.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
		...
		case OP_glGetShaderPrecisionFormat: {
			...
			glGetShaderPrecisionFormat(var_shadertype, var_precisiontype, (GLint*)(outptr_range.get()), (GLint*)(outptr_precision.get()));
			outptr_range.flush();
		...
		case OP_glGetShaderSource: {
			...
			glGetShaderSource(var_shader, var_bufsize, size_length == 0 ? NULL : (GLsizei*)(outptr_length.get()), (GLchar*)(outptr_source.get()));
			outptr_length.flush();
			outptr_source.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
		...
		case OP_glGetUniformfv: {
			...
			glGetUniformfv(var_program, var_location, (GLfloat*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetUniformiv: {
			...
			glGetUniformiv(var_program, var_location, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetUniformLocation: {
			...
			*(int *)(&tmpBuf[0]) = 			glGetUniformLocation(var_program, (const GLchar*)(inptr_name.get()));
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glGetVertexAttribfv: {
			...
			glGetVertexAttribfv(var_index, var_pname, (GLfloat*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetVertexAttribiv: {
			...
			glGetVertexAttribiv(var_index, var_pname, (GLint*)(outptr_params.get()));
			outptr_params.flush();
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
		...
		case OP_glGetVertexAttribPointerv: {
			...
			glGetVertexAttribPointerv(var_index, var_pname, (GLvoid**)(inptr_pointer.get()));
		...
		case OP_glIsFramebuffer: {
			...
			*(GLboolean *)(&tmpBuf[0]) = 			glIsFramebuffer(var_framebuffer);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glIsProgram: {
			...
			*(GLboolean *)(&tmpBuf[0]) = 			glIsProgram(var_program);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glIsRenderbuffer: {
			...
			*(GLboolean *)(&tmpBuf[0]) = 			glIsRenderbuffer(var_renderbuffer);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glIsShader: {
			...
			*(GLboolean *)(&tmpBuf[0]) = 			glIsShader(var_shader);
			if (useChecksum) {
				ChecksumCalculatorThreadInfo::writeChecksum(&tmpBuf[0], totalTmpSize - checksumSize, &tmpBuf[totalTmpSize - checksumSize], checksumSize);
			}
			stream->flush();
		...
		case OP_glRenderbufferStorage: {
			...
			glRenderbufferStorage(var_target, var_internalformat, var_width, var_height);
		...
		case OP_glShaderBinary: {
			...
			glShaderBinary(var_n, (const GLuint*)(inptr_shaders.get()), var_binaryformat, (const GLvoid*)(inptr_binary.get()), var_length);
		...
		case OP_glShaderSource: {
			...
			glShaderSource(var_shader, var_count, (const GLchar* const*)(inptr_string.get()), (const GLint*)(inptr_length.get()));
		...
		case OP_glStencilFuncSeparate: {
			...
			glStencilFuncSeparate(var_face, var_func, var_ref, var_mask);
		...
		case OP_glStencilMaskSeparate: {
			...
			glStencilMaskSeparate(var_face, var_mask);
		...
		case OP_glStencilOpSeparate: {
			...
			glStencilOpSeparate(var_face, var_fail, var_zfail, var_zpass);
		...
		case OP_glUniform1f: {
			...
			glUniform1f(var_location, var_x);
		...
		case OP_glUniform1fv: {
			...
			glUniform1fv(var_location, var_count, (const GLfloat*)(inptr_v.get()));
		...
		case OP_glUniform1i: {
			...
			glUniform1i(var_location, var_x);
		...
		case OP_glUniform1iv: {
			...
			glUniform1iv(var_location, var_count, (const GLint*)(inptr_v.get()));
		...
		case OP_glUniform2f: {
			...
			glUniform2f(var_location, var_x, var_y);
		...
		case OP_glUniform2fv: {
			...
			glUniform2fv(var_location, var_count, (const GLfloat*)(inptr_v.get()));
		...
		case OP_glUniform2i: {
			...
			glUniform2i(var_location, var_x, var_y);
		...
		case OP_glUniform2iv: {
			...
			glUniform2iv(var_location, var_count, (const GLint*)(inptr_v.get()));
		...
		case OP_glUniform3f: {
			...
			glUniform3f(var_location, var_x, var_y, var_z);
		...
		case OP_glUniform3fv: {
			...
			glUniform3fv(var_location, var_count, (const GLfloat*)(inptr_v.get()));
		...
		case OP_glUniform3i: {
			...
			glUniform3i(var_location, var_x, var_y, var_z);
		...
		case OP_glUniform3iv: {
			...
			glUniform3iv(var_location, var_count, (const GLint*)(inptr_v.get()));
		...
		case OP_glUniform4f: {
			...
			glUniform4f(var_location, var_x, var_y, var_z, var_w);
		...
		case OP_glUniform4fv: {
			...
			glUniform4fv(var_location, var_count, (const GLfloat*)(inptr_v.get()));
		...
		case OP_glUniform4i: {
			...
			glUniform4i(var_location, var_x, var_y, var_z, var_w);
		...
		case OP_glUniform4iv: {
			...
			glUniform4iv(var_location, var_count, (const GLint*)(inptr_v.get()));
		...
		case OP_glUniformMatrix2fv: {
			...
			glUniformMatrix2fv(var_location, var_count, var_transpose, (const GLfloat*)(inptr_value.get()));
		...
		case OP_glUniformMatrix3fv: {
			...
			glUniformMatrix3fv(var_location, var_count, var_transpose, (const GLfloat*)(inptr_value.get()));
		...
		case OP_glUniformMatrix4fv: {
			...
			glUniformMatrix4fv(var_location, var_count, var_transpose, (const GLfloat*)(inptr_value.get()));
		...
		case OP_glVertexAttrib1f: {
			...
			glVertexAttrib1f(var_indx, var_x);
		...
		case OP_glVertexAttrib1fv: {
			...
			glVertexAttrib1fv(var_indx, (const GLfloat*)(inptr_values.get()));
		...
		case OP_glVertexAttrib2f: {
			...
			glVertexAttrib2f(var_indx, var_x, var_y);
		...
		case OP_glVertexAttrib2fv: {
			...
			glVertexAttrib2fv(var_indx, (const GLfloat*)(inptr_values.get()));
		...
		case OP_glVertexAttrib3f: {
			...
			glVertexAttrib3f(var_indx, var_x, var_y, var_z);
		...
		case OP_glVertexAttrib3fv: {
			...
			glVertexAttrib3fv(var_indx, (const GLfloat*)(inptr_values.get()));
		...
		case OP_glVertexAttrib4f: {
			...
			glVertexAttrib4f(var_indx, var_x, var_y, var_z, var_w);
		...
		case OP_glVertexAttrib4fv: {
			...
			glVertexAttrib4fv(var_indx, (const GLfloat*)(inptr_values.get()));
		...
		case OP_glVertexAttribPointer: {
			...
			glVertexAttribPointer(var_indx, var_size, var_type, var_normalized, var_stride, (const GLvoid*)(inptr_ptr.get()));
		...
		case OP_glGetProgramBinaryOES: {
			...
			glGetProgramBinaryOES(var_program, var_bufSize, (GLsizei*)(inptr_length.get()), (GLenum*)(inptr_binaryFormat.get()), (GLvoid*)(inptr_binary.get()));
		...
		case OP_glProgramBinaryOES: {
			...
			glProgramBinaryOES(var_program, var_binaryFormat, (const GLvoid*)(inptr_binary.get()), var_length);
		...
		case OP_glTexImage3DOES: {
			...
			glTexImage3DOES(var_target, var_level, var_internalformat, var_width, var_height, var_depth, var_border, var_format, var_type, size_pixels == 0 ? NULL : (const GLvoid*)(inptr_pixels.get()));
		...
		case OP_glTexSubImage3DOES: {
			...
			glTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_width, var_height, var_depth, var_format, var_type, size_pixels == 0 ? NULL : (const GLvoid*)(inptr_pixels.get()));
		...
		case OP_glCopyTexSubImage3DOES: {
			...
			glCopyTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_x, var_y, var_width, var_height);
		...
		case OP_glCompressedTexImage3DOES: {
			...
			glCompressedTexImage3DOES(var_target, var_level, var_internalformat, var_width, var_height, var_depth, var_border, var_imageSize, size_data == 0 ? NULL : (const GLvoid*)(inptr_data.get()));
		...
		case OP_glCompressedTexSubImage3DOES: {
			...
			glCompressedTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_width, var_height, var_depth, var_format, var_imageSize, size_data == 0 ? NULL : (const GLvoid*)(inptr_data.get()));
		...
		case OP_glFramebufferTexture3DOES: {
			...
			glFramebufferTexture3DOES(var_target, var_attachment, var_textarget, var_texture, var_level, var_zoffset);
		...
		case OP_glMultiDrawArraysEXT: {
			...
			glMultiDrawArraysEXT(var_mode, (const GLint*)(inptr_first.get()), (const GLsizei*)(inptr_count.get()), var_primcount);
		...
		case OP_glMultiDrawElementsEXT: {
			...
			glMultiDrawElementsEXT(var_mode, (const GLsizei*)(inptr_count.get()), var_type, (const GLvoid* const*)(inptr_indices.get()), var_primcount);
		...
		case OP_glGetPerfMonitorGroupsAMD: {
			...
			glGetPerfMonitorGroupsAMD((GLint*)(inptr_numGroups.get()), var_groupsSize, (GLuint*)(inptr_groups.get()));
		...
		case OP_glGetPerfMonitorCountersAMD: {
			...
			glGetPerfMonitorCountersAMD(var_group, (GLint*)(inptr_numCounters.get()), (GLint*)(inptr_maxActiveCounters.get()), var_counterSize, (GLuint*)(inptr_counters.get()));
		...
		case OP_glGetPerfMonitorGroupStringAMD: {
			...
			glGetPerfMonitorGroupStringAMD(var_group, var_bufSize, (GLsizei*)(inptr_length.get()), (GLchar*)(inptr_groupString.get()));
		...
		case OP_glGetPerfMonitorCounterStringAMD: {
			...
			glGetPerfMonitorCounterStringAMD(var_group, var_counter, var_bufSize, (GLsizei*)(inptr_length.get()), (GLchar*)(inptr_counterString.get()));
		...
		case OP_glGetPerfMonitorCounterInfoAMD: {
			...
			glGetPerfMonitorCounterInfoAMD(var_group, var_counter, var_pname, (GLvoid*)(inptr_data.get()));
		...
		case OP_glGenPerfMonitorsAMD: {
			...
			glGenPerfMonitorsAMD(var_n, (GLuint*)(inptr_monitors.get()));
		...
		case OP_glDeletePerfMonitorsAMD: {
			...
			glDeletePerfMonitorsAMD(var_n, (GLuint*)(inptr_monitors.get()));
		...
		case OP_glSelectPerfMonitorCountersAMD: {
			...
			glSelectPerfMonitorCountersAMD(var_monitor, var_enable, var_group, var_numCounters, (GLuint*)(inptr_countersList.get()));
		...
		case OP_glBeginPerfMonitorAMD: {
			...
			glBeginPerfMonitorAMD(var_monitor);
		...
		case OP_glEndPerfMonitorAMD: {
			...
			glEndPerfMonitorAMD(var_monitor);
		...
		case OP_glGetPerfMonitorCounterDataAMD: {
			...
			glGetPerfMonitorCounterDataAMD(var_monitor, var_pname, var_dataSize, (GLuint*)(inptr_data.get()), (GLint*)(inptr_bytesWritten.get()));
		...
		case OP_glGetFenceivNV: {
			...
			glGetFenceivNV(var_fence, var_pname, (GLint*)(inptr_params.get()));
		...
		case OP_glCoverageOperationNV: {
			...
			glCoverageOperationNV(var_operation);
		...
		case OP_glGetDriverControlsQCOM: {
			...
			glGetDriverControlsQCOM((GLint*)(inptr_num.get()), var_size, (GLuint*)(inptr_driverControls.get()));
		...
		case OP_glGetDriverControlStringQCOM: {
			...
			glGetDriverControlStringQCOM(var_driverControl, var_bufSize, (GLsizei*)(inptr_length.get()), (GLchar*)(inptr_driverControlString.get()));
		...
		case OP_glExtGetTexturesQCOM: {
			...
			glExtGetTexturesQCOM((GLuint*)(inptr_textures.get()), var_maxTextures, (GLint*)(inptr_numTextures.get()));
		...
		case OP_glExtGetBuffersQCOM: {
			...
			glExtGetBuffersQCOM((GLuint*)(inptr_buffers.get()), var_maxBuffers, (GLint*)(inptr_numBuffers.get()));
		...
		case OP_glExtGetRenderbuffersQCOM: {
			...
			glExtGetRenderbuffersQCOM((GLuint*)(inptr_renderbuffers.get()), var_maxRenderbuffers, (GLint*)(inptr_numRenderbuffers.get()));
		...
		case OP_glExtGetFramebuffersQCOM: {
			...
			glExtGetFramebuffersQCOM((GLuint*)(inptr_framebuffers.get()), var_maxFramebuffers, (GLint*)(inptr_numFramebuffers.get()));
		...
		case OP_glExtGetTexLevelParameterivQCOM: {
			...
			glExtGetTexLevelParameterivQCOM(var_texture, var_face, var_level, var_pname, (GLint*)(inptr_params.get()));
		...
		case OP_glExtGetTexSubImageQCOM: {
			...
			glExtGetTexSubImageQCOM(var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_width, var_height, var_depth, var_format, var_type, (GLvoid*)(inptr_texels.get()));
		...
		case OP_glExtGetBufferPointervQCOM: {
			...
			glExtGetBufferPointervQCOM(var_target, (GLvoidptr*)(inptr_params.get()));
		...
		case OP_glExtGetShadersQCOM: {
			...
			glExtGetShadersQCOM((GLuint*)(inptr_shaders.get()), var_maxShaders, (GLint*)(inptr_numShaders.get()));
		...
		case OP_glExtGetProgramsQCOM: {
			...
			glExtGetProgramsQCOM((GLuint*)(inptr_programs.get()), var_maxPrograms, (GLint*)(inptr_numPrograms.get()));
