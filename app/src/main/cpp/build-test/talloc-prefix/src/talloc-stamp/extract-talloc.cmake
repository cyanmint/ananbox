...
#
get_filename_component(filename "/home/runner/work/ananbox/ananbox/app/src/main/cpp/build-test/talloc-prefix/src/talloc-2.4.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/ananbox/ananbox/app/src/main/cpp/build-test/talloc-prefix/src/talloc" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-talloc${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-talloc${i}")
