...
#
get_filename_component(filename "/home/runner/work/ananbox/ananbox/app/src/main/cpp/build-test/_deps/libunwind-populate/libunwind-prefix/src/libunwind-1.3.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/ananbox/ananbox/app/src/main/cpp/build-test/_deps/libunwind-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libunwind${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libunwind${i}")
