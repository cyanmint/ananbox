...
ExternalProject_Add(
        ...
        INSTALL_COMMAND cd ${TALLOC_SRC} && mkdir -p ${TALLOC_INCLUDE_DIRS} ${TALLOC_BIN}/lib && ${CMAKE_AR} rcs ${TALLOC_STATIC_LIB} bin/default/talloc.c*.o && cp -f talloc.h ${TALLOC_INCLUDE_DIRS}
)